...
\textbf{B.S. in Mathematics Honors} and \textbf{B.S. in Physics}\hfill May 2026\\
\textit{Purdue University}, West Lafayette, IN \\
...
\begin{enumerate}[leftmargin=*,label=\arabic*.]
    ...
    \hfill September 2024 -- May 2025
    \\Advised by Prof. Jonathon Peterson at Purdue University
    \begin{itemize}
    ...
    \\Advised by Prof. Emmanuel Stamou at TU Dortmund, Germany (Exchange Program)
...
\subsection*{Talks}
\begin{enumerate}
    \item ``From BCFW recursions to the amplituhedron.''
    \textit{Purdue High Energy Physics Seminar.} West Lafayette, IN. \hfill November~2025

    \item {``Branching random walk in random environment.''}
    \textit{Purdue Mathematics Undergraduate Research Presentation Night.} West Lafayette, IN. \hfill April~2025

    \item {``Spectral methods in learning theory of Boolean functions.''}
    \textit{Purdue Graduate Student Probability Seminar.} West Lafayette, IN. \hfill April 2025

    \item {``Probabilitistic proofs of $L^p$ maximal inequalities for semigroups.''} \textit{Report for MA545 Topics in Analysis.} West Lafayette, IN. \hfill December 2024

    \item {``Convergence of scaled asymptotically-free self-interacting random walks to Brownian motion perturbed at Extrema.''}
    \textit{Rose-Hulman Undergraduate Mathematics Conference.} Terre Haute, IN. \hfill April 2024
...
\begin{enumerate}
    \item {``Convergence of scaled asymptotically-free self-interacting random walks to Brownian motion perturbed at extrema.''}
    \textit{Seminar on Stochastic Processes.} Bloomington, IN. \hfill March 2025

    \item {``Separating standard model and SUSY dataframes using neural networks.''}
    Joint work with R. Patel, C. Suh and Y. Wu.
    \textit{Purdue Undergraduate Research Exhibition.} West Lafayette, IN. \hfill April 2024
...
\item \textbf{Jerison Memorial Award in Analysis}, Purdue University (2024) \\
Awarded annually to an outstanding undergraduate for excellence in analysis, in memory of functional analyst Meyer Jerison.

\item \textbf{Joel Spira Undergraduate Research Fellowship}, Purdue University (2023) \\
Fellowship supporting undergraduate research under faculty mentorship, endowed by Joel S.\ Spira and Ruth R.\ Spira.

\item \textbf{Glen E.\ Baxter Award with Interests in Probability Theory}, Purdue University (2023) \\
Memorial award recognizing exceptional senior undergraduates with strong interest in probability, combinatorial analysis, or statistics.

\item \textbf{Outstanding Sophomore in Mathematics}, Purdue University (2023) \\
Given to a sophomore mathematics major demonstrating exceptional academic achievement and promise in mathematics.
