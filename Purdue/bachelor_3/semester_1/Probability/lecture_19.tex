...
\begin{proof}
	...
	\[
		\{I_s(e^n) - I_t(e^m)\} _{t \in [0,T]} \qquad \text{ is a martingale}
	.\] 
	Therefore, by Doob's maximal inequality,
	\[
		P\left( \sup _{0 \le t\le T} \left| I_t(e^m) - I_t(e^m) \right| \ge \varepsilon \right) 
		\le \frac{1}{\varepsilon^2} E \left| I_T(e^n) - I_T(e^m) \right| ^2
	.\] 
	(If an operator takes from L2 to L2, then it takes from weak L2 to L2. This is Chebyshev.)
...
Note: There is also square bracket $[M_t]$ for process that has jumps.
