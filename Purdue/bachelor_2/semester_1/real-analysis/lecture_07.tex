...
\begin{definition}
	\textit{Open cells} in $\mathbb{R}^p$ are Cartesian products of open intervals.
	\textit{Closed cells} in $\mathbb{R}^p$ are Cartesian products of closed intervals.

	Products of all types of intervals are also called \textit{cells}.
\end{definition}
