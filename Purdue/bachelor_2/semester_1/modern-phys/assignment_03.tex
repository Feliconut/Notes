...
\begin{proof}[Solution]
	...
	By conservation of relativistic total energy, and the assumption that the two protons have equal energy, hence each proton has relativistic energy $E / 2 =\SI{339.200}{\mega\electronvolt} $
	...
	Proton only has kinetic energy since it has zero mas. Therefore its momentum is
	\begin{align*}
		p &= \frac{1}{c}\sqrt{E^2 - m^2 c^4}\\ 
		&= \frac{E}{c}  \\
	...
	Now we solve the angle of emitted protons by using conservation of relativistic momentum in the vector form.
	\begin{align*}
...
\begin{proof}[Solution]
	...
	\[
		\hat{p}  = \hat{p} _1 + \hat{p} _2 =   \SI{0.5303}{\mega \electronvolt \per c}  \hat{x} 
	.\] 
