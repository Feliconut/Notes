...
\begin{corollary}[Cauchy Integral Formula]
	...
	\[
		f(a) = \frac{1}{2 \pi i } \int_{\partial \mathcal{D}} \frac{f(a)}{z-a}dz
	\]
\end{corollary}
\begin{proof}
...
\begin{corollary}[Cauchy's Differentiation Formula]
	Differentiable functions are infinitely differentiable. Moreover,
\[
...
\begin{proof}
	Write
\[
	f(z) = \frac{1}{2 \pi i}\int _{\partial \mathcal{D}}\frac{f(\zeta)}{\zeta - z} d \zeta, \quad z \in \mathcal{D}
.\]	
This is infinitely differentiable wrt $z$, since $\frac{1}{\zeta - z}$ is infinitely differentiable. The formula comes easily via induction.
\end{proof}
test
