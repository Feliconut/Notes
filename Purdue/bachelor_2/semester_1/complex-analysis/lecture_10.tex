\lecture{10}{Thu 22 Sep 2022 12:07}{Cauchy's Theorem}
...
\begin{figure}[htpb]
	\centering
	\includegraphics[width=0.3\textwidth]{figures/path-deformation.png}
	\caption{(1) Region and path as in Green's Theorem, proving path independence; (2) A continuous deformation of curve; (3) A Starlike region.}
	\label{fig:path-deformation}
\end{figure}
...
\begin{example}
	\begin{enumerate}
		\item Every convex region is simply connected.
...
\begin{figure}[htpb]
	\centering
	\includegraphics[width=0.8\textwidth]{figures/path-winding.png}
	\caption{Closed integral in domain of analyticity only depends on the winding number.}
	\label{fig:path-winding}
\end{figure}
\item The integral 
	\[
