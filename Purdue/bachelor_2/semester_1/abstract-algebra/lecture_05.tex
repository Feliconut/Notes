...
\begin{proof}
	Let $G$ be a group, and put $S = G$. We define the set $A(G)$ to be the set of bijective self-mapping of $G$. Observe that whenever $a \in G$, the map 
	\begin{align*}
	...
	We need to construct an isomorphism $\varphi:G \to H$. Define 
	\begin{align*}
