...
.\end{align*}
\begin{correction}
	Need to also show for negative $n$. The induction only covered nonnegative $n$.
\end{correction}
\end{proof}
...
Prove that $G$ is a group. (Thus you must show that $x * e=x$ and $x * y=e$ for $e, y$ as above.) \logseq{review}
\begin{proof}
...
Show that $G$ is a group. \logseq{review}
\begin{proof}
...
\begin{correction}
	1-1 means injective. onto means surjective. 1-1 correspondence means bijective.
\end{correction}
\end{proof}
