...
\begin{proof}
	...
	Thus $G$ has a non-trivial subgroup $N$. Since $G$ is abelian, one has $N \triangleleft G$. Then \[
		|G / N| \cdot |N| = |G| \equiv 0 \pmod p
	.\] 
	So $p \mid |N|$ or $p \mid |G / N|$. In the first case we are done. In the second case, (to be filled in the next class)
\end{proof}
