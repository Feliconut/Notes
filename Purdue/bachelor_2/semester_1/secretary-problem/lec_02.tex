...
{\color{red} Exercise: Show that $\sum_{i=1}^ni^k = \frac{1}{k+1}n^{k+1}+O(n^k)$}
...
{\color{red} Exercise: Show that the upper bound of $P^{\text{max}}$ among all deterministic algorithms is $\frac{1}{2}$}
...
{\color{red} Exercise: Show that the upper bound of $P^{\text{max}}$ among all randomized algorithms is $\frac{1}{2}$}
