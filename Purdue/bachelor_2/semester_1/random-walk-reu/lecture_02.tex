...
\[
	...
	= O\left( \exp\left( - \frac{n^\kappa}{2} \right)  \right)   
.\] 
...
\begin{proof}
	...
	$\alpha(0,1)$ is an extreme value among the variance temrs; this explains why the dependence on first step is significantly larger.
\end{proof}
