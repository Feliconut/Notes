...
The current goal is to generalize the results in \cite{kosyginaConvergenceNonconvergenceScaled2022} about asymptotically free self-intereacting random walk (AF-SIRW) to the case  $p \le \frac{1}{2}$, since the proof in the paper works only for  $p > \frac{1}{2}$.
